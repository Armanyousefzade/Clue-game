    ...
    public void hadsZadan() {
        ...
        if (realPlayer == true) {
            ...
            if (input.nextInt() == 1) {
                String roomName;
                while (true) {
                    System.out.println("Esme otaghi ke hads mizanid javab moamma hast ra vared konid:");
                    roomName = input.next();
                ...
                while (true) {
                    System.out.println("Esme aslaheie ke hads mizanid javabe moamma hast ra vared konid:");
                    gunName = input.next();
                    if (containsInGuns(gunName) == false) {
                        System.out.println("slaheiee ba chenin nami vojood nadarad");
                        continue;
                ...
                while (true) {
                    System.out.println("Esme maznooni ke hads mizanid javabe moamma hast ra vared konid:");
                    characterName = input.next();
                    if (containsInCharacters(characterName) == false) {
                        System.out.println("Maznooni ba chenin nami vojood nadarad");
                        continue;
